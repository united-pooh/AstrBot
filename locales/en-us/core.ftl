...
initial_loader-critical_init_failed = 😭 Failed to initialize AstrBot: {e} !!!
initial_loader-info_shutting_down = 🌈 Shutting down AstrBot...
...
pipeline-result_decorate-stage-prepend_thinking_content = 🤔 Thinking: {reasoning_content}\n
...
platform-sources-discord-discord_platform_adapter-adapter_description = Discord Adapter (based on Pycord)
